package com.sivtcev.expensetracker.filters;
        ...
        if (authHeader != null) {
            ...
            if (authHeaderArr.length > 1 && authHeaderArr[1] != null) {
                ...
                try {
                    ...
                    httpServletRequest.setAttribute("userId", Long.parseLong(claims.get("userId").toString()));
                } catch (Exception e) {
                    httpServletResponse.sendError(HttpStatus.FORBIDDEN.value(), "invalid or expire token");
                    return;
                }
            } else {
